...
type GetAppOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.AppObject `json:"body,omitempty"`
}
...
func (o *GetAppOK) WithPayload(payload *models.AppObject) *GetAppOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get app o k response
func (o *GetAppOK) SetPayload(payload *models.AppObject) {
	o.Payload = payload
}
...
func (o *GetAppNotFound) WithPayload(payload *models.NotFound) *GetAppNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get app not found response
func (o *GetAppNotFound) SetPayload(payload *models.NotFound) {
	o.Payload = payload
}
